...
#define MyAppAssocName "PAWN Script"
#define MyAppAssocExt ".pwn"
#define MyAppAssocKey "DAWNO.File"

[Setup]
AppId={{com.deks.dawno}}
AppName={#MyAppName}
...
[Files]
Source: "..\dist\DAWNO-win32-x64\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
